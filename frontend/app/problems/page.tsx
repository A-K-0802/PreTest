...
import { Search, Code2, ChevronLeft } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-between items-center bg-[#131b2e] p-4 rounded border border-[#1f2937]">
          <div className="w-full md:w-96 relative">
            ...
            <input
              ...
              className="w-full bg-[#0b1326] border border-[#3c4a42] rounded pl-9 pr-4 py-2 text-xs text-[#dbe2fd] placeholder:text-[#bbcabf]/40 font-mono focus:outline-none focus:border-[#10b981]"
            />
          </div>
