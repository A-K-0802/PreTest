    ...
    <div className="flex min-h-screen w-full bg-[#0b1326] text-[#dbe2fd] font-sans selection:bg-[#10b981] selection:text-[#0b1326]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#0b1326] items-center justify-center border-r border-[#1f2937] p-12">
        <div className="relative z-10 max-w-lg space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-3xl font-bold text-[#dbe2fd] tracking-tight">Master the technical interview.</h2>
            <p className="text-[#bbcabf] text-base leading-relaxed">
              Access high-density problem sets, real-time performance analytics, and a terminal-grade practice environment designed for elite engineers.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 pt-8">
            <div className="border border-[#1f2937] bg-[#171f33] p-5 rounded">
              <span className="font-mono text-xs text-[#10b981] uppercase tracking-widest block mb-1">Library</span>
              <div className="text-2xl font-bold text-[#dbe2fd]">2,400+</div>
              <p className="text-xs text-[#bbcabf] font-mono mt-0.5">Curated Problems</p>
            </div>
            <div className="border border-[#1f2937] bg-[#171f33] p-5 rounded">
              <span className="font-mono text-xs text-[#10b981] uppercase tracking-widest block mb-1">Global Rank</span>
              <div className="text-2xl font-bold text-[#dbe2fd]">TOP 1%</div>
              <p className="text-xs text-[#bbcabf] font-mono mt-0.5">Interview Ready</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#0b1326] p-8">
        <div className="w-full max-w-md space-y-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#dbe2fd] tracking-tight">Welcome Back</h2>
            <p className="text-xs text-[#bbcabf] font-mono mt-1">Sign in to your engineer dashboard to resume training.</p>
          </div>
          ...
          <div className="my-6 flex items-center justify-between">
            ...
            <span className="px-3 text-[11px] font-mono text-[#bbcabf] uppercase shrink-0">or social sign-in</span>
            <span className="w-full border-t border-[#1f2937]" />
          </div>
